  ...
  return (
    <div>
      <div className="noprint">
        ...
        <button className="print-btn" onClick={print} disabled={loading}>
          Download
        </button>
      </div>

      <div className="minimalist-theme" ref={componentRef}>
        {/* Top Section */}
        <div className="minimalist-top">
          <div>
        ...
        {/* Contact Information */}
        <div className="minimalist-contact mt-4">
        ...
        {/* Skills Section */}
        <div className="minimalist-skills mt-4">
          <h3>Technical Skills</h3>
          {state?.personal?.technicalskill?.length > 0 ? (
            <ul>
        ...
        {/* Interests Section */}
        <div className="minimalist-interests mt-4">
          <h3>Interests</h3>
        ...
        {/* Experience Section */}
        <div className="minimalist-experience mt-4">
        ...
        {/* Education Section */}
        <div className="minimalist-education mt-4">
          <h3>Education</h3>
        ...
        {/* Projects Section */}
        <div className="minimalist-projects mt-4">
          <h3>Projects</h3>
        ...
        {/* Courses Section */}
        <div className="minimalist-courses mt-4">
          <h3>Courses</h3>
